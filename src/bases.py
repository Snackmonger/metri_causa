...
"""Base classes for building text and token crawlers."""
...
class Token:
    """Generic token."""
    def __init__(self, token_type: TokenType, lexeme: str) -> None:
...
class Parser:
    ...
    def consume(self, token_type: TokenType, message: str) -> Optional[Token]:
        """Consume a token."""
